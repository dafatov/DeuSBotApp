...
module.exports = [
  'help', interaction, {
    embeds: [
      new MessageEmbed({
        color: 16777040,
        description: 'Данный бот (Deus v1.5.1) был разработан DemetriouS (aka dafatov) в рамках частного проекта специально для дискорд сервера на чистом энтузиазме\n\nСайт бота: https://discord-bot-deus-web.onrender.com/',
        footer: {
